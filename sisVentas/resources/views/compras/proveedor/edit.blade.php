...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<!--para mostrar posibles errores que puedan existir -->
		@if (count($errors)>0)
			...
			<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
				<div class="form-group">
			      <label for="num_documento">Número Documento</label>
			       <input type="text" name="num_documento" value="{{$persona->num_documento}}" class="form-control" placeholder="Númeno de Documento...">
		      </div>
			</div>
			<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
				<div class="form-group">
